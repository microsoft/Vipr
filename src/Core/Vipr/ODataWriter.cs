...
#line 1 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
...
#line 9 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
            ProcessModel();
...
#line 10 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
        ...
        public string GetType(OdcmType odcmType, bool isCollection)
        {
            ...
            if (string.Equals(odcmType.Namespace, _currentNamespace.Name, StringComparison.OrdinalIgnoreCase))
            {
        ...
        private OdcmNamespace _currentNamespace;
...
#line 130 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
...
#line 131 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
...
#line 141 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
                this.Write("\r\npublic ");
...
#line 143 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
...
#line 144 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
            }
            else
            {
...
#line 148 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
                this.Write("\r\npublic ");
...
#line 150 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
                this.Write(this.ToStringHelper.ToStringWithCulture(odcmClass.IsAbstract ? "abstract " : string.Empty));
...
#line 151 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
            }
...
#line 153 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
            this.Write("{\r\n");
...
#line 155 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
...
#line 165 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
            this.Write("}\r\n");
...
#line 167 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
...
#line 177 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
            this.Write("\r\npublic ");
...
#line 179 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
...
#line 181 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
...
#line 183 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
...
#line 185 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
...
#line 187 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
            this.Write("\r\n}\r\n");
...
#line 190 "E:\gittf\Roxel\O365\Public\src\EdmDecomposition\EdmDecomposition\ODataWriter.tt"
...
#line hidden
    ...
    {
        #region Fields
        private global::System.Text.StringBuilder _generationEnvironmentField;
        private global::System.CodeDom.Compiler.CompilerErrorCollection _errorsField;
        private global::System.Collections.Generic.List<int> _indentLengthsField;
        private string _currentIndentField = "";
        private bool _endsWithNewline;
        private global::System.Collections.Generic.IDictionary<string, object> _sessionField;
        #endregion
        #region Properties
        /// <summary>
        ...
        protected System.Text.StringBuilder GenerationEnvironment
        {
            get
            {
                ...
                {
                    _generationEnvironmentField = new global::System.Text.StringBuilder();
                }
        ...
        public System.CodeDom.Compiler.CompilerErrorCollection Errors
        {
            get
            {
                ...
                {
                    _errorsField = new global::System.CodeDom.Compiler.CompilerErrorCollection();
                }
                return _errorsField;
            }
        }
        ...
        private System.Collections.Generic.List<int> indentLengths
        {
            get
            {
                ...
                {
                    _indentLengthsField = new global::System.Collections.Generic.List<int>();
                }
        ...
        public void Write(string textToAppend)
        {
            ...
            if (((this.GenerationEnvironment.Length == 0)
                        || _endsWithNewline))
            {
                this.GenerationEnvironment.Append(_currentIndentField);
            ...
            textToAppend = textToAppend.Replace(global::System.Environment.NewLine, (global::System.Environment.NewLine + _currentIndentField));
            // If the text ends with a newline, then we should strip off the indent added at the very end
            // because the appropriate indent will be added when the next time Write() is called
            if (_endsWithNewline)
            {
                this.GenerationEnvironment.Append(textToAppend, 0, (textToAppend.Length - _currentIndentField.Length));
            }
            else
            {
                this.GenerationEnvironment.Append(textToAppend);
