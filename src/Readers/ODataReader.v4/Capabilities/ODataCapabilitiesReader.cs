...
namespace ODataReader.v4.Capabilities
{
    public class ODataCapabilitiesReader
    {
        ...
        /// </summary>
        /// <param name="odcmEntitySet">OdcmProperty representing the annotated EntitySet</param>
        /// <param name="edmEntitySet">EdmModel annoataed EntitySet</param>
        /// <param name="serviceModel">EdmModel</param>
