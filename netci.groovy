...
// Defines a the new of the repo, used elsewhere in the file.  This is passed in from the job
// that runs this file.
...
[true, false].each { isPR -> // Defines a closure over true and false, value assigned to isPR
    ...
    Utilities.simpleInnerLoopJobSetup(newJob, project, isPR, "Windows Build and Test")
}