...
namespace CSharpWriterUnitTests
{
    public static class PropertyInfoAssertionsExtensions
    {
        ...
        /// <param name="isMatchingAttributePredicate">The predicate that the attribute must match.
        ///             </param><param name="because">A formatted phrase as is supported by <see cref="M:System.String.Format(System.String,System.Object[])"/> explaining why the assertion
        ///             is needed. If the phrase does not start with the word <i>because</i>, it is prepended automatically.
        ///             </param><param name="reasonArgs">Zero or more objects to format using the placeholders in <see cref="!:because"/>.
        ///             </param>
        public static AndConstraint<PropertyInfoAssertions> BeDecoratedWith<TAttribute>(
            this PropertyInfoAssertions propertyInfoAssertions,
            string because = "", params object[] reasonArgs) where TAttribute : Attribute
        {
            Execute.Assertion.ForCondition(propertyInfoAssertions.Subject.GetCustomAttributes(typeof (TAttribute)).Any())
                .BecauseOf(because, reasonArgs)
                .FailWith(
                    "Expected type {0} to be decorated with {1}, but no matching attribute was found.",
        ...
        {
            BeDecoratedWith<TAttribute>(propertyInfoAssertions, because, reasonArgs);
